...
describe('UserFieldCore', () => {
  ...
  it('should convert cellValue to string', () => {
    const cellValue: IUserCellValue = {
      id: 'usrxxxxxxxxx',
      title: 'anonymous',
      email: 'anonymous@anxinlirong.com',
    };
  ...
  it('should convert string to cellValue', () => {
    ...
    expect(field.convertStringToCellValue('anonymous@anxinlirong.com', ctx)).toEqual({
      id: 'usr1234567',
      title: 'anonymous',
      email: 'anonymous@anxinlirong.com',
    });
  ...
  it('should validate value', () => {
    ...
    expect(
      field.validateCellValue({ id: 'usrxxxxxx ', title: '', email: 'anonymous@anxinlirong.com' }).success
    ).toBe(true);
