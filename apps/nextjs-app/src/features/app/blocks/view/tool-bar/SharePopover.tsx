...
const getShareUrl = ({
  ...
  const origin = typeof window !== 'undefined' ? window.location.origin : 'https://jbs.smyun.net';
...
export const SharePopover: React.FC<{
  ...
  // Grid 视图显示「允许编辑」配置项；26年4月17日修改分享视图权限
  const needConfigEdit = [ViewType.Grid].includes(view.type);
        ...
        {enableShare ? (
          <>
            ...
            <div className="space-y-4">
              ...
              {/* 分享弹窗内开关 allowEdit；26年4月17日修改分享视图权限 */}
              {needConfigEdit && (
                <div className="flex items-center gap-2">
                  <Switch
                    id="share-allowEdit"
