...
import { useRecordOperations, useTableId, useView } from '@teable/sdk/hooks';
import {
  cn,
  Command,
  CommandGroup,
...
export const EventMenu = () => {
  ...
  const { deleteRecord, duplicateRecord } = useRecordOperations();
  const view = useView();
    ...
    [
      {
        ...
        onClick: async () => {
          if (!tableId) return;
          await deleteRecord({ tableId, recordId: eventId });
        },
      },
    ],
