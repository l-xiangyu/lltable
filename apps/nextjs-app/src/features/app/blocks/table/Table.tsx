...
import { JbsReferenceRecordsProvider } from '@/features/embed/JbsReferenceRecordsProvider';
import { JbsUserFieldProvider } from '@/features/embed/JbsUserFieldProvider';
import {
  CellDownloadHandler,
        ...
        <ViewProvider serverData={viewServerData}>
          <PersonalViewProxy serverData={viewServerData}>
            <FieldProvider serverSideData={fieldServerData}>
              <JbsReferenceRecordsProvider>
                <JbsUserFieldProvider>
                  <PersonalViewProvider>
