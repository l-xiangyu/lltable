...
export class BaseController {
  ...
  // Base usage endpoint for front-end billing/feature checks.
  // Here we simply return an "Enterprise" level with very loose limits
  // so that all features are effectively enabled.
  @Permissions('base|read')
  @Get(':baseId/usage')
  async getBaseUsage() {
    return {
      ...
      limit: {
        ...
        maxRevisionHistoryDays: 3650,
        maxAutomationHistoryDays: 3650,
